...
$timeout=time()-900;
try {
	$stmt = $conexao->prepare("SELECT usuario, vila, renegado, nivel, vitorias, derrotas, yens_fat, timestamp, personagem FROM usuarios".$filtro." ORDER BY nivel DESC, yens_fat DESC, vitorias DESC, derrotas ASC LIMIT ?,50");
	$stmt->execute([($pg*50)]);
